...
public abstract class AbstractApplyResultOperationSelector<T, D extends AbstractApplyResultOperationSelector<T, D>>
  ...
  public AbstractApplyResultOperationSelector(ResultWithStatus<T> resultWithStatus, String errorMessage, Object... params) {
   ...
   * </p>
   */
  public D proxyOnly(Integer... statuses) {
   ...
   * </p>
   */
  public D proxyOnly(Status... statuses) {
   ...
   * </p>
   */
  public D convertAndProxy(Integer source, Integer target) {
   ...
   * </p>
   */
  public D convertAndProxy(Status source, Status target) {
