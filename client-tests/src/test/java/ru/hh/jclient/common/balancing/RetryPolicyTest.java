...
public class RetryPolicyTest {
  ...
  public void testDefault() {
    ...
    assertTrue(policy.isRetriable(createResponse(CONNECT_ERROR, CONNECT_ERROR_MESSAGE), true));
    assertTrue(policy.isRetriable(createResponse(CONNECT_ERROR, CONNECT_ERROR_MESSAGE), false));
    ...
    assertTrue(policy.isRetriable(createResponse(REQUEST_TIMEOUT, REQUEST_TIMEOUT_MESSAGE), true));
    assertFalse(policy.isRetriable(createResponse(REQUEST_TIMEOUT, REQUEST_TIMEOUT_MESSAGE), false));
  }
  ...
  public void testNonIdempotentRetry() {
    ...
    assertFalse(policy.isRetriable(createResponse(REQUEST_TIMEOUT, REQUEST_TIMEOUT_MESSAGE), true));
    assertFalse(policy.isRetriable(createResponse(REQUEST_TIMEOUT, REQUEST_TIMEOUT_MESSAGE), false));
  }
